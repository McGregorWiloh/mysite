...
def post_share(request, post_id):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            send_mail(subject, message, "kudziwilo@gmail.com", [cd["to"]])
            sent = True
    else:
        form = EmailPostForm()
    return render(
...
def post_comment(request, post_id):
    ...
    if form.is_valid():
        ...
        comment = form.save(
            commit=False # commit=False the object is not saved to database this allows us to modify the object before finally saving it
